...
function(msg='default'){
    list(msg=glue::glue("The message is '{}'."))
}

#*Add the two numbers
#* @param x:numeric First number
#* @parm y:numeric Second number
#* @get /add
function(x,y){
...
#* @param Income:numeric Income,expected in hundreds
...
#* @param Job:string Type of job one of "fixed"/"freelance"/"others","parttime"
#* @get /predict
